...
<title>/home/pasquale/map/ReligionJS/node_modules/express/node_modules/path-to-regexp/.Readme.md.html</title>
...
<h1> <a name="user-content-path-to-regexp" class="anchor" href="..md.html#path-to-regexp" aria-hidden="true"><span class="octicon octicon-link"></span></a>Path-to-RegExp</h1> 
...
<div class="highlight highlight-javascript">
 <pre><span class="kd">var</span> <span class="nx">pathToRegexp</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">'path-to-regexp'</span><span class="p">);</span>
</pre>
</div> 
<h3> <a name="user-content-pathtoregexppath-keys-options" class="anchor" href="..md.html#pathtoregexppath-keys-options" aria-hidden="true"><span class="octicon octicon-link"></span></a>pathToRegexp(path, keys, options)</h3> 
<ul> 
...
<div class="highlight highlight-javascript">
 <pre><span class="kd">var</span> <span class="nx">keys</span> <span class="o">=</span> <span class="p">[];</span>
...
<h2> <a name="user-content-live-demo" class="anchor" href="..md.html#live-demo" aria-hidden="true"><span class="octicon octicon-link"></span></a>Live Demo</h2> 
